...
|---|---|:---:|---|---|---|
| [**D1-01**](D1-01-extorsion-pymes.md) | **Extorsión a Pymes y Cobro de Cupos** | `critical` | 85k denuncias vs. 20 sentencias (0.02% efectividad) | **$45B** | Hardware LoRaWAN Mesh + Facturación y Cobro Ciego (Zero-Knowledge) |
...
* **Cartera 1.1: Asuntos de Orden Interno y Policía**
  * *1.1.1. Inteligencia Táctica y Crimen Organizado* (Extorsión, narcotráfico VRAEM, minería ilegal del oro).
  * *1.1.2. Seguridad Ciudadana y Policía Comunitaria* (Telemetría urbana 105, botones de pánico).
  * *1.1.3. Control Migratorio y Fronteras Interiores* (Pasos clandestinos, biometría).
* **Cartera 1.2: Asuntos de Defensa Nacional y Seguridad Territorial**
  * *1.2.1. Soberanía de Espacios Estratégicos* (Enclaves ilícitos, control marítimo 200 millas).
  * *1.2.2. Ciberdefensa de Infraestructura Crítica* (Redes eléctricas y plantas hídricas).
* **Cartera 1.3: Asuntos de Justicia, Fe Pública y Derechos Reales**
  * *1.3.1. Gestión Procesal Penal y Ministerio Público* (Carpetas físicas en papel, peritajes contables).
  * *1.3.2. Régimen Penitenciario y Rehabilitación Social* (Hacinamiento >130%, llamadas extorsivas de penales).
  * *1.3.3. Registros Públicos, Catastro y Fe Notarial* (Duplicidad de partidas registrales, jueces de paz falsificadores).
